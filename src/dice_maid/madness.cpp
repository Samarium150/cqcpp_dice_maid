...
string Madness::get_symptom(int type) {
	...
	if (type == 0) 
		result << "临时症状: 1d10=" << (num + 1) << endl << mad_a[num];
	else
		result << "总结症状: 1d10=" << (num + 1) << endl << mad_b[num];
