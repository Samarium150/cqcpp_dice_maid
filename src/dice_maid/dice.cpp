...
void Dice::init() {
    ...
    int skipper = (int)(temp.tm_min * (temp.tm_mon + 1) % ((temp.tm_hour + 1) * (temp.tm_year + 1900))
...
string Dice::coc() {
    ...
    int total = strength + constitution + size + dexterity + appearance + intelligence + power + education + luck;
    result << "调查员作成Ex:" << endl;
